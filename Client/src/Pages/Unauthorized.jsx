...
const Unauthorized = () => {
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-black">
      <div className="bg-black p-8 rounded-lg shadow-lg text-center animate__animated animate__fadeIn">
        {/* Animated Icon */}
        <FontAwesomeIcon
          icon={faExclamationTriangle}
          className="text-yellow-500 text-6xl mb-4 animate__animated animate__tada animate__delay-1s"
        />
        <h1 className="text-3xl font-bold text-gray-300 mb-4">Access Denied</h1>
